...
export default function Home(): React.ReactElement {
  const { isReady, isAvailable, theme, colorScheme, expand, showAlert } =
    useMax();
      ...
      <div className="container mx-auto px-4 py-8 max-w-2xl">
        <div className="mb-8">
          ...
          <p className="text-lg opacity-80">
            Современное мини-приложение для мессенджера Max
          </p>
        </div>
        ...
        {isAvailable ? (
            ...
            <Card>
              ...
              <div className="space-y-2">
                ...
                {user && (
                  <>
                    <p>
                      <strong>Пользователь:</strong> {user.first_name}{" "}
                      {user.last_name ?? ""}
                    </p>
                    {user.username && (
                      <p>
          ...
          <Card>
            <h2 className="text-xl font-semibold mb-4">
              Приложение не запущено в Max
            </h2>
            <p className="opacity-80">
              Для полной функциональности откройте это приложение через
              мессенджер Max.
            </p>
          </Card>
        )}
